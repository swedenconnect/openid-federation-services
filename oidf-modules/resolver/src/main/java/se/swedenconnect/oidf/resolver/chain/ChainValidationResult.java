 ...
 */
public record ChainValidationResult(List<SignedJWT> chain, List<Exception> errors,
   ...
   * @param errors for this chain validation
   */
  public ChainValidationResult(final List<SignedJWT> chain, final List<Exception> errors) {
