...
public class ResolverFactory {
  public static ResolverClient createTestResolver(final ResolverProperties properties, final FederationTree tree,
    ...
    return new ResolverClient(resolver, properties.entityIdentifier(), resolverKey, () -> entityStatementTree.load(new EntityStatementTreeLoader(tree, new DFSExecution()).withAdditionalPostHook(
  ...
  private static EntityStatementTree getEntityStatementTree(final ResolverProperties properties,
      final FederationTree tree, final VersionedInMemoryCache<EntityStatement> entityStatementInMemoryDataLayer) {
    ...
    final EntityStatementTreeLoader loader = new EntityStatementTreeLoader(tree, new DFSExecution()).withAdditionalPostHook(entityStatementInMemoryDataLayer::useNextVersion);
