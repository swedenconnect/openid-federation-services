...
import se.digg.oidfed.service.entity.registry.RegistryReloadEvent;
...
public class ReloadEndpoint {
   ...
   */
  public ReloadEndpoint(final ApplicationEventPublisher publisher) {
  ...
  void reloadFromRegistry() {
    ...
    this.publisher.publishEvent(new RegistryReloadEvent());
  }
}
