 ...
 */
public record CacheRegistration(EntityStatementTree tree, EntityStatementTreeLoader loader,
    VersionedCacheLayer<EntityStatement> cache, ResolverProperties properties) {
}
