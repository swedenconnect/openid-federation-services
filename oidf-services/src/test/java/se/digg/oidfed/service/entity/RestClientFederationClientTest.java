...
public class RestClientFederationClientTest {
  ...
  @Test
  void testEmbedded() {
    final FederationClient federationClient = new RestClientFederationClient(RestClient.builder().build());
    ...
    final EntityStatement entityStatement = federationClient.entityConfiguration(new FederationRequest<>(new EntityConfigurationRequest(new EntityID(
        "https://unsused")),
        Map.of("subject_entity_configuration_location", embedded), true));
