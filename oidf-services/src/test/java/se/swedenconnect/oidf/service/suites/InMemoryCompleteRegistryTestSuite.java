...
@Slf4j
@Suite
@SuiteDisplayName("In Memory + Registry Test Suite")
@SelectClasses(value = {
...
public class InMemoryCompleteRegistryTestSuite {
  ...
  public static void start() throws InterruptedException {
    try {
      ...
      registryMock.initCustom("4860ae57-9716-492b-951c-2a8c334f790a");
    } catch (Exception e) {
      throw new RuntimeException(e);
    }
    final MockEnvironment mockEnvironment = new MockEnvironment();
    final SpringApplicationBuilder memory = new SpringApplicationBuilder()
        ...
        .environment(mockEnvironment
            ...
            .withProperty("federation.local-registry.entities", "")
            .withProperty("federation.local-registry.resolvers", "")
            .withProperty("federation.local-registry.trust-anchors", "")
            .withProperty("federation.local-registry.trust-mark-issuers", "")
    ...
    configurableApplicationContext = memory
        .run();
